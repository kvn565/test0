...
urlpatterns = [
    ...
    path('transactions/sorties/<int:pk>/compenser-obr/', views.sortie_compenser_obr, name='sortie_compenser_obr'),
    path('transactions/entrees/<int:pk>/compenser-obr/', views.entree_compenser_obr, name='entree_compenser_obr'),
]
